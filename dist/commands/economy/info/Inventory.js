...
exports.default = {
    ...
    execute: function (message, args, client) {
        return __awaiter(this, void 0, void 0, function () {
            var target, user, items, embed, desc, _i, items_1, item;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        target = parseUsers_1.default(args, message)[0] || message.author;
                        if (!target)
                            return [2 /*return*/, message.channel.send("User not found!")];
                        return [4 /*yield*/, dbObjects_1.Users.findOne({ where: { user_id: target.id } })];
                    case 1:
                        user = _a.sent();
                    ...
                    case 2:
                        items = _a.sent();
                        if (!items.length)
                            return [2 /*return*/, message.channel.send("**" + target.username + "** has nothing!")];
