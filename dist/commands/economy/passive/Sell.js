...
exports.default = {
    ...
    execute: function (message, args, client) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var item, user, amount, userItem, refund;
            var _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, index_1.CurrencyShop.findOne({
                            where: { name: (_b = {}, _b[sequelize_1.Op.like] = args[0], _b) },
                        })];
                    case 1:
                        item = _c.sent();
                        return [4 /*yield*/, index_1.Users.findOne({
                    ...
                    case 3:
                        userItem = (_c.sent()).find(function (i) { return i.dataValues.item.name === item.name; });
                        if (userItem.dataValues.amount < amount) {
                            message.channel.send("Sorry, but you don't have enough items");
                            return [2 /*return*/, "invalid"];
                        }
                        if (["all", "max"].includes(args[1]))
                            amount = userItem.dataValues.amount;
                        refund = Math.floor(userItem.item.dataValues.cost / 2) * amount;
                        user.income(refund);
