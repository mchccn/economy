        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        user = _a.sent();
                        maxDep = user.max_bank - user.bank;
                        if (maxDep === 0)
                            return [2 /*return*/, message.channel.send("Your bank is full!")];
                        ...
                        toDep = maxDep >= amount ? amount : amount - maxDep;
                        ...
                        user.save();
                        return [2 /*return*/, message.channel.send("You deposited " + toDep + " coins!")];
                }
            });
        });
    },
