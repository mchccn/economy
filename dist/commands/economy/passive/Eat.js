...
exports.default = {
    ...
    execute: function (message, args, client) {
        return __awaiter(this, void 0, void 0, function () {
            var item, user, userItem, multiplier;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        userItem = (_b.sent()).find(function (i) { return i.dataValues.item.name === item.name; });
                        if (!userItem || userItem.dataValues.amount <= 0)
                            return [2 /*return*/, message.channel.send("You don't have that item!")];
                        userItem.decrement("amount");
                        userItem.save();
                        multiplier = 0.01;
                        user.multiplier += multiplier;
                        user.save();
                        return [2 /*return*/, message.channel.send("You eat your " + item.name.toLowerCase() + " and magically gain a " + Math.floor(multiplier * 100) + "% multiplier.")];
                }
            });
        });
    },
