        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        user = _a.sent();
                        on = ["on", "yes", "y", "true", "enable"];
                        off = ["off", "no", "n", "false", "disable"];
                        if (args[0]) {
                            switch (args[0]) {
                                case "passive":
                                    if (on.includes(args[1])) {
                                        user.passive = true;
                                        user.save();
                                        return [2 /*return*/, message.channel.send("Set the `passive` setting to `" + args[1] + "`")];
                                    }
                                    ...
                                    return [2 /*return*/, message.channel.send("Currently set to `" + (user.passive ? "on" : "off"))];
                                default:
