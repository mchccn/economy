...
var parseRoles_1 = __importDefault(require("../../utils/parseRoles"));
    ...
    execute: function (message, args, client) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                role = parseRoles_1.default(args, message)[0];
                if (!role) {
                ...
                return [2 /*return*/, message.channel.send(new discord_js_1.MessageEmbed()
                        ...
                        .addField("Permissions", parseTrim_1.default(role.permissions
                        .toArray()
                        .map(function (p) { return parseCase_1.default(p); })
                        .join("\n"), 1024))
                        .setColor(role.color)
